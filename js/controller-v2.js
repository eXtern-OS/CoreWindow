...
let dragging = false;
/*
$("#hoverDetection").on('mousedown',function (e) {
    //dragging = true;
	//console.log("dragging: ",dragging)
});*/

/*
$("#hoverDetection").on('mouseup',function (e) {
  //dragging = false;
  //console.log("dragging: ",dragging)
});*/
...
const appCommsChannel = new BroadcastChannel("eXternOSApp"+winId); //Comms channel between process manager and this App
...
setTimeout(function(){ 
			...
			if (ev.data.type == "init-objects") {
				...
				w//in.internalId = ev.data.internalId;
